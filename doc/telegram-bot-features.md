...
## 2. Feature Implementation Status in cctelegram
...
### Currently Forwarded by cctelegram
...
|---------|---------------------|----------|
| `/clear` | ↗ Clear conversation history | Wipes conversation, starts fresh. cctelegram also clears session association |
