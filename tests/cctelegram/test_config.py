...
class TestConfigClaudeProjectsPath:
    def test_default_claude_projects_path(self, monkeypatch):
        ...
        monkeypatch.delenv("CCTELEGRAM_CLAUDE_PROJECTS_PATH", raising=False)
        monkeypatch.delenv("CLAUDE_CONFIG_DIR", raising=False)
        cfg = Config()
        assert cfg.claude_projects_path == Path.home() / ".claude" / "projects"

    def test_custom_claude_projects_path(self, monkeypatch):
        """CCTELEGRAM_CLAUDE_PROJECTS_PATH overrides the default path."""
        custom_path = "/custom/projects/path"
        monkeypatch.setenv("CCTELEGRAM_CLAUDE_PROJECTS_PATH", custom_path)
        cfg = Config()
    ...
    def test_cctelegram_projects_path_takes_priority(self, monkeypatch):
        """CCTELEGRAM_CLAUDE_PROJECTS_PATH takes priority over CLAUDE_CONFIG_DIR."""
        monkeypatch.setenv("CCTELEGRAM_CLAUDE_PROJECTS_PATH", "/priority/path")
