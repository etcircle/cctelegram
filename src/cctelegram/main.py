...
def _build_parser() -> argparse.ArgumentParser:
    ...
    hook.add_argument(
        "--install",
        action="store_true",
        help="Install the SessionStart hook in ~/.claude/settings.json.",
    )

    subparsers.add_parser(
        "doctor",
        help="Check CCTelegram state/config directory.",
    )
    return parser
...
def main(argv: list[str] | None = None) -> None:
    """Main entry point for the cctelegram console script."""
